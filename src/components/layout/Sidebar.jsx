...
export const Sidebar = () => {
  const { sidebarCollapsed, setSidebarCollapsed, stats, mobileMenuOpen, setMobileMenuOpen, cmsHeroSlides, cmsBlogs, logout } = useAdmin();
              ...
              <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-2.5 flex items-center justify-between">
                <div className="flex items-center gap-2 overflow-hidden">
                  ...
                  <div className="truncate">
                    <p className="text-[11px] font-semibold text-slate-200 truncate">Super Admin Secure</p>
